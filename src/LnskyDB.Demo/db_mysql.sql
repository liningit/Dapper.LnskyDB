...
CREATE TABLE `Purify_ProductSaleByDayNS` (
  ...
  `CreateUserID` char(50)  DEFAULT NULL,
  `UpdateDate` timestamp NULL DEFAULT NULL,
  `UpdateUserID` char(50)  DEFAULT NULL,
  `ImportGroupId` char(50)  DEFAULT NULL,
  `IsExclude` bit(1) NOT NULL DEFAULT b'0',
  PRIMARY KEY (`SysNo`)
) ENGINE=InnoDB AUTO_INCREMENT=28009 ;
